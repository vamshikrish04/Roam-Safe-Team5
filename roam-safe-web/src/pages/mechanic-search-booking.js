...
export default function MechanicSearchBooking() {
          ...
          >
            <Grid container>
              ...
              >
                ...
                <Typography variant="h6">
                  <CallIcon /> Mobile no. :{" "}
                  <span style={{ fontWeight: "400" }}>{val.phone_number}</span>
                </Typography>
                <Typography variant="h6">
                  <FactoryIcon /> Company Name :{" "}
                  <span style={{ fontWeight: "400" }}>{val.company_name}</span>
                </Typography>
                <Typography variant="h6">
                  <LocationOnIcon /> Address :{" "}
                  <span style={{ fontWeight: "400" }}>{val.address}</span>
                </Typography>
                <Link to={`/book-service/${val._id}`} sx={{ padding: "1rem" }}>
                  <Button
                    color="error"
                    variant="contained"
