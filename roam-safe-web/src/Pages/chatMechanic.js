...
export default function ChatMechanic() {
  ...
  const getMessages = async () => {
    ...
    const response = await getApihandler(`/getChat/${clientId}/${userId}`);
  ...
  const onSubmit = async (value) => {
    const response = await postApihandler(`/sendText/${clientId}/${userId}`, {
      type: "Mechanic",
      text: message,
    });
